...
<br>**Contributors**: Aidan Claderhead, Angel Perez Vila, Georgio Di Liegro, Zachary Biery

## About the project
Hotel cancellations are a major challenge in the hospitality industry, leading to lost revenue, inefficient staffing, and poor inventory planning. This project aims to solve that problem by predicting which reservations are likely to cancel using historical booking data from two hotels in Portugal. By leveraging machine learning, we capture complex patterns across booking behaviors, customer types, and seasonal trends—patterns that traditional forecasting methods often miss. Our system supports real-time and batch predictions and provides actionable insights for hotel managers, revenue analysts, and front desk staff, helping them optimize pricing, staffing, and service delivery. Our tool's predictive capability empowers decision-makers with reliable data to stay ahead of cancellations and streamline operations.
